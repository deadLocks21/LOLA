...
function create_Sector_Student(id, label1, label2) {
    let sector = create_Sector_ProfSimple(id, label1, label2);

    sector.classList.add("openSector");
    sector.classList.remove("clickable");
